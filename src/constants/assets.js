/**
 * tokihomu-lab SVGアイコン定数およびヘルパー
 */

// 白黒ハチワレ猫（タキシード猫）のSVGアイコン定数
export const TOKI_SVG = `
...
export const AMERICAN_SHORTHAIR_SVG = `
